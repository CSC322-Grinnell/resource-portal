...
resources = [
   ...
   {name: "Grinnell Community Meal", phone_number: "", 
                ...
                description_of_service: "Free meal prepared by community members and Grinnell College Social Justice Action Group.
...
{name: "Grinnell Food SHARE", phone_number: "641-236-3972",
                ...
                description_of_service: "Order and pay for food the first Tues. of each month at Grinnell Senior Center, 12:30 – 1:30 pm.
...
{name: "Bountiful Baskets Food Co-op",
                ...
                description_of_service: "For an introduction, select the tab “New Participant Instructions”
...
{name: "Imagine Grinnell", phone_number: "641-236-5518", 
                ...
                description_of_service: "Coordinates the Grinnell Community Garden, which offers low-cost and free growing space. Plot
reservations are due in the month of March; the growing season is April through November. Also
provides free summer educational programming."}, # Food
...
{name: "Mid-Iowa Community Action (MICA)", phone_number: "641-236-3923", 
                ...
                description_of_service: "Operates an emergency food pantry for those in need; distributes vouchers for milk and bread
